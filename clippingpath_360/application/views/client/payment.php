                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover order-column" id="sample_1">
                                ...
                                <tr>
                                    ...
                                    <th> <i class="fa fa-credit-card"></i> Amount(Approved) </th>
                                ...
                                if ($history){
                                    foreach($history  as $r):?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <?php if ($r->status =='rejected'){echo '<b style="color: red">Rejected</b>' ; } elseif ($r->status=='completed'){echo '<b style="color: green">Accepted</b>';} elseif ($r->status=='new'){echo '<b style="color: #0a6aa1">Pending</b>';} elseif ($r->status=='adjustment'){echo '<b style="color: #6a5422">Adjustment</b>';} ?>
                                            </td>
                                            <td>
                                                <?php echo $r->amount;?>$
                                            </td>
                                            <td>
                                                <?php echo $r->approved_amount;?>$
                                            </td>
                                            <td>
                                                <p><?php echo $r->date;?></p>
                                            </td>
