...
<head>
    ...
    <link href="<?php echo base_url(); ?>assets/pages/css/rating.css" rel="stylesheet" type="text/css" />
...
<div class="page-wrapper">
    ...
    <div class="page-header navbar navbar-fixed-top">
        ...
        <div class="page-header-inner ">
            ...
            <div class="page-logo">
                <a href="index.php">
                    <img src="<?php echo base_url(); ?>images/logo.png" alt="logo" height="25" width="170" class="logo-default" /> </a>
            ...
            <div class="top-menu">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-extended dropdown-notification">
                        <span href="javascript:;" style="color: #fff;font-weight: bolder;top: 30%;display: block;position: relative">Available Balance:
                            <i class="fa fa-dollar"></i> <?php
                            $sum = 0;
                            foreach($balance as $amount)
                            {if ($amount['subject']=='add_fund'){
                                $sum+= $amount['approved_amount'];
                            }elseif ($amount['subject']=='refund'){
                                $sum= $sum- $amount['approved_amount'];
                            }elseif ($amount['subject']=='paid'){
                                $sum= $sum- $amount['amount'];
                            }elseif ($amount['subject']=='addFund_minus'){
                                $sum= $sum- $amount['amount'];
                            }elseif ($amount['subject']=='refund_plus'){
                                $sum= $sum+ $amount['amount'];
                            }
                            }
                            echo $sum;
                    ...
                    <li class="dropdown dropdown-user">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            ...
                            <span class="username username-hide-on-mobile"> <?php echo $client['user_name']?> </span>
                ...
                <input type="hidden" id="client_balance" value="<?php echo $sum ?>">
            </div>
