                    ...
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover order-column" id="sample_1">
                                ...
                                <?php
                                if ($menu_item){
                                    foreach($menu_item  as $r): if ($r->status !='new' && $r->status != 'adjustment'){?>
                                        <tr class="odd gradeX">
                                            <!--<td>
                                                <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                            ...
                                            <td <?php if ($r->subject=='refund') echo 'style="color: red"' ;else echo 'style="color: green"'?>>
                                                <b><?php if ($r->subject == 'refund') echo 'Refund';else echo 'Add Fund'?></b></td>
                                            <td>
                                                <?php if ($r->status=='rejected') echo '<b style="color: red">Rejected</b>' ;elseif($r->status=='completed') echo '<b style="color: green">Accepted</b>';?>
                                            </td>
                                            <td>
                                                <?php echo $r->amount;?>$
                                            </td>
