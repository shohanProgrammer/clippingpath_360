    ...
    <div class="page-content">
        <div class="portlet box purple ">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-gift"></i>Completed Project</div>
                <div class="tools">
            ...
            <div class="portlet-body">
                <div class="tabbable-line tabbable-custom-profile">
                    <table class="table table-striped table-bordered table-advance table-hover">
                        ...
                        <tr>
                            <th>
                                <i class="fa fa-cc-jcb"></i> Job Title </th>
                            <th class="hidden-xs">
                                <i class="fa fa-question"></i> Descrition </th>
                            <th>
                                <i class="fa fa-credit-card"></i> Amount </th>
                            <th>
                                <i class="fa fa-calendar"></i> Posted On </th>
                            <th> </th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm grey-salsa btn-outline" href=""> View </a>
                            </td>
                        </tr>
                        <tr>
                            <td>
